        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          >
            {featuredEvent ? (
              <div className="bg-white p-6 sm:p-8 rounded-3xl border-2 border-[#1E1B4B] shadow-[8px_8px_0px_0px_#1E1B4B] space-y-6 relative">
                <div className="space-y-1">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant={featuredEvent.status === 'LIVE' ? 'pink' : 'yellow'}>{featuredEvent.status}</Badge>
                  </div>
                ...
                <div className="p-4 rounded-2xl bg-[#FAF7EE] border-2 border-[#1E1B4B] space-y-1 text-xs font-bold text-[#1E1B4B] shadow-[2px_2px_0px_0px_#1E1B4B]">
                  <p className="flex items-center gap-2">
                    <Calendar className="w-4 h-4 text-[#1E1B4B]" /> Date: {featuredEvent.eventDate} ({featuredEvent.durationHours} Hours)
                  </p>
                </div>
              ...
              <div className="bg-white p-8 rounded-3xl border-2 border-[#1E1B4B] shadow-[8px_8px_0px_0px_#1E1B4B] text-center space-y-4">
                <Trophy className="w-12 h-12 text-[#1E1B4B] mx-auto" />
                <h3 className="text-2xl font-black text-[#1E1B4B]">No Active Events Created Yet</h3>
                <p className="text-xs font-bold text-slate-600">
                  Access the Admin Portal to create, launch, and manage real hackathons with Google Forms registration.
                </p>
                <Link to="/admin-portal">
                  <Button variant="yellow" className="w-full py-3.5">Go to Admin Portal</Button>
                </Link>
              </div>
            )}
          </motion.div>
