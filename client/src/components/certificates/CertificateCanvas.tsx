...
import { Sparkles, ShieldCheck, Award, QrCode } from 'lucide-react';
    ...
    <div className="glass-card bg-white p-8 sm:p-12 rounded-3xl border-8 border-purple-200 text-center space-y-6 shadow-2xl relative overflow-hidden max-w-2xl mx-auto">
      ...
      <div className="flex items-center justify-between border-b border-purple-100 pb-4 relative z-10">
        <div className="flex items-center gap-2">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-purple-600 to-pink-500 text-white flex items-center justify-center font-black">
            <Sparkles className="w-5 h-5" />
          </div>
          <span className="text-xl font-extrabold text-slate-900">{communityName}</span>
        </div>
